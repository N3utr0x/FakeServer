  ...
  .then(async dBase => {
    ...
    try {
      if (!exists) {
        ...
        await db.run(
          "INSERT INTO users (username, password,token) VALUES ('Bart Simpsom','b8a3ts1mp3oms3454321','48799'), ('Liza Simpsom','l1s4asim3p9som563034','45741'), ('administrator','ad1m45sis56tem8roo8t','33347')"
        );
      } else {
